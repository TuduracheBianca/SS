<div class="card">
    <div class="card-header border-bottom border-dashed d-flex align-items-center">
        <h4 class="header-title">Lista materii</h4>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-muted text-center">
                            <a href="{SITE_URL}/materii/edit/{id_materie}" class="link-reset fs-15 p-1">
                                <i class="ti ti-pencil" style="font-size: 0.85rem;"></i>
                            </a>
                            <a href="{SITE_URL}/materii/delete/{id_materie}" class="link-reset fs-15 p-1">
